...
/* Stretch
    Rather than an array as a parameter, your function will now have any number of arguments passed
    into it. The core function of your function remains the same, find the largest of the parameters

    Hint
    e.g.
*/ 

function largestNumberStretch() {
    return Math.max(...arguments);
}


/* Stretch Solution Explanation
